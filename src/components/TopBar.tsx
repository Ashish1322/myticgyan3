    ...
    <div className="bg-primary text-primary-foreground py-2 text-sm z-[60] relative">
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://www.instagram.com/mysticvigyan3?igsh=MTEyZ3N4b3dxaGtodQ==" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors" aria-label="Instagram">
